...
class Routes(
  ...
  def documentation = List(
    ("""GET""", this.prefix, """controllers.HomeController.welcome"""),
  ...
  // @LINE:6
  private[this] lazy val controllers_HomeController_welcome0_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix)))
  )
  private[this] lazy val controllers_HomeController_welcome0_invoker = createInvoker(
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:6
    case controllers_HomeController_welcome0_route(params) =>
      call { 
        controllers_HomeController_welcome0_invoker.call(HomeController_0.welcome)
      }
